    ...
    accounts: {
      ...
      openai: {
        ...
        oauthPassthroughDesc:
          '开启后，OpenAI API Key 账号的 Responses 与 Chat Completions 请求均按原生端点直转，仅替换认证并保留计费、并发、审计及必要安全过滤；OAuth 账号保持 Responses 透传。',
      ...
      quotaControl: {
        ...
        tlsFingerprint: {
          ...
          stableAssignmentHint: '将按账号稳定选择 Profile；新增模板可能只影响部分账号。'
        },
        sessionIdMasking: {
          label: '会话 ID 伪装',
      ...
      noProxy: '无代理',
      concurrency: '并发数',
      concurrencyHint: '0 表示不限制，也可以填写较大的并发数。',
      loadFactor: '负载因子',
      ...
      diagnosingConnection: '诊断中...',
      diagnosticTitle: '出站连接诊断',
      diagnosticLastChecked: '最近检查：{time}',
      diagnosticSuccess: '网络路径已到达目标站点',
      diagnosticFailed: '网络路径未到达目标站点',
      diagnosticTarget: '目标',
      diagnosticProxy: '代理',
      diagnosticProxyEndpoint: '代理端点',
      diagnosticExitIP: '出口 IP',
      diagnosticDNS: '本机 DNS',
      diagnosticTLS: 'TLS',
      diagnosticALPN: 'ALPN',
      diagnosticHTTP: 'HTTP',
      diagnosticProfile: 'TLS Profile',
      latency: '延迟',
      diagnosticNotObserved: '未观测到',
      diagnosticDirect: '直连',
      diagnosticUnavailable: '不可用',
      diagnosticStatusNotChecked: '未检查',
      diagnosticStatusLocalResolved: '本机已解析',
      diagnosticStatusLookupFailed: '本机解析失败',
      diagnosticStatusObserved: '已观测到',
      diagnosticStatusProbeFailed: '探测失败',
      diagnosticStatusNotObserved: '未观测到',
      diagnosticFailureDNS: 'DNS',
      diagnosticFailureProxy: '代理/TCP',
      diagnosticFailureTLS: 'TLS',
      diagnosticFailureTimeout: '超时',
      diagnosticFailureHTTP: 'HTTP 请求',
      diagnosticFailureUnknown: '连接',
      diagnosticDisclaimer: '这里只检查网络路径，不验证订阅、额度、授权或服务商风控结果。',
      transportHealthTitle: 'Transport 健康摘要',
      transportHealthRuntime: '当前进程',
      transportHealthLoading: '正在读取连接统计...',
      transportHealthUnavailable: '连接统计暂不可用',
      transportHealthRequests: '请求总数',
      transportHealthResults: '成功 / 失败',
      transportHealthPool: '复用 / 新建',
      transportHealthHTTP2: 'HTTP/2 成功 / 回退',
      transportHealthFailures: '代理 / TLS / 超时',
      transportHealthProtocol: '最近协议',
      transportHealthIdentity: '连接身份 / 代次',
      transportHealthIdentityTarget: '身份目标主机',
      transportHealthLastFailure: '最近失败阶段',
      transportHealthLastFailureAt: '最近失败时间',
      transportHealthHTTP1Fallback: 'HTTP/1.1 回退',
      transportHealthDefaultProtocol: '默认协议',
      transportHealthNone: '暂无',
      transportHealthStageAcquire: '获取 Transport',
      transportHealthStageProxy: '代理连接',
      transportHealthStageTLS: 'TLS 握手',
      transportHealthStageHTTP2: 'HTTP/2 兼容性',
      transportHealthStageTimeout: '超时',
      transportHealthStageNetwork: '网络',
      transportHealthStageRequest: '请求',
      transportHealthDisclaimer: '仅统计当前进程内的连接行为，服务重启后会清零；不保存代理地址、凭据或错误原文。',
      // Stats Modal
      viewStats: '查看统计',
