    ...
    accounts: {
      ...
      openai: {
        ...
        oauthPassthroughDesc:
          'When enabled, OpenAI API Key accounts forward Responses and Chat Completions through their native endpoints while only replacing authentication and preserving billing, concurrency, audit, and required safety filtering. OAuth accounts keep Responses passthrough.',
      ...
      quotaControl: {
        ...
        tlsFingerprint: {
          ...
          stableAssignmentHint: 'A profile is selected stably per account; adding a profile may affect only some accounts.'
        },
        sessionIdMasking: {
      ...
      concurrencyHint: '0 means unlimited; larger concurrency values are also supported.',
      ...
      diagnosticTitle: 'Outbound connection diagnostic',
      diagnosticLastChecked: 'Last checked: {time}',
      diagnosticSuccess: 'Network path reached the target',
      diagnosticFailed: 'Network path did not reach the target',
      diagnosticTarget: 'Target',
      diagnosticProxy: 'Proxy',
      diagnosticProxyEndpoint: 'Proxy endpoint',
      diagnosticExitIP: 'Exit IP',
      diagnosticDNS: 'Local DNS',
      diagnosticTLS: 'TLS',
      diagnosticALPN: 'ALPN',
      diagnosticHTTP: 'HTTP',
      diagnosticProfile: 'TLS Profile',
      latency: 'Latency',
      diagnosticNotObserved: 'Not observed',
      diagnosticDirect: 'Direct',
      diagnosticUnavailable: 'Unavailable',
      diagnosticStatusNotChecked: 'Not checked',
      diagnosticStatusLocalResolved: 'Resolved locally',
      diagnosticStatusLookupFailed: 'Local lookup failed',
      diagnosticStatusObserved: 'Observed',
      diagnosticStatusProbeFailed: 'Probe failed',
      diagnosticStatusNotObserved: 'Not observed',
      diagnosticFailureDNS: 'DNS',
      diagnosticFailureProxy: 'Proxy/TCP',
      diagnosticFailureTLS: 'TLS',
      diagnosticFailureTimeout: 'Timeout',
      diagnosticFailureHTTP: 'HTTP request',
      diagnosticFailureUnknown: 'Connection',
      diagnosticDisclaimer: 'This is a network-path check only. It does not verify subscription, quota, authorization, or provider risk decisions.',
      transportHealthTitle: 'Transport health summary',
      transportHealthRuntime: 'Current process',
      transportHealthLoading: 'Loading connection counters...',
      transportHealthUnavailable: 'Connection counters are unavailable',
      transportHealthRequests: 'Requests',
      transportHealthResults: 'Success / failure',
      transportHealthPool: 'Reused / created',
      transportHealthHTTP2: 'HTTP/2 success / fallback',
      transportHealthFailures: 'Proxy / TLS / timeout',
      transportHealthProtocol: 'Last protocol',
      transportHealthIdentity: 'Connection identity / generation',
      transportHealthIdentityTarget: 'Identity target',
      transportHealthLastFailure: 'Last failure stage',
      transportHealthLastFailureAt: 'Last failure time',
      transportHealthHTTP1Fallback: 'HTTP/1.1 fallback',
      transportHealthDefaultProtocol: 'Default protocol',
      transportHealthNone: 'None',
      transportHealthStageAcquire: 'Transport acquire',
      transportHealthStageProxy: 'Proxy connection',
      transportHealthStageTLS: 'TLS handshake',
      transportHealthStageHTTP2: 'HTTP/2 compatibility',
      transportHealthStageTimeout: 'Timeout',
      transportHealthStageNetwork: 'Network',
      transportHealthStageRequest: 'Request',
      transportHealthDisclaimer: 'Process-local counters only. They reset after restart and never store proxy addresses, credentials, or raw error text.',
      // Stats Modal
